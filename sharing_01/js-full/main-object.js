...
function createThree(scene) {
	var Three = function(){
		this.mesh = new THREE.Object3D();


		var threeGeo = new THREE.CylinderGeometry(1, 8, 60, 5, 5);
		var threeMat = new THREE.MeshLambertMaterial({
			color: '#4B1717',
			transparent: false,
			opacity: 1,
		})
		...
		var three = new THREE.Mesh( threeGeo , threeMat );
